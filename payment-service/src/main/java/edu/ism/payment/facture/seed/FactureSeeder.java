...
/**
 * Seed des factures au demarrage (CommandLineRunner).
 *
 ...
 * (au minimum juillet 2026).
 *
 * Patterns: Factory, Strategy, Builder.
 */
@Component
public class FactureSeeder implements CommandLineRunner {
    ...
    // Dernier mois minimum genere par le seed.
    ...
    public void run(String... args) throws Exception {
        ...
        // dernierMois : mois courant, borne au minimum a DERNIER_MOIS_MIN.
